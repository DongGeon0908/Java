 ...
 *        화씨온도를 섭씨온도로 변환하여 출력하는 텍스트 기반의 입출력 예제
 *        
 *   o 온도 체계
 ...
 * [ 실습과제 ]
 *
 *   1) 이 프로그램은 화씨온도를 섭씨온도로 변환하여 출력하는 텍스트 기반 프로그램이다.
 ...
 *      변환하여 출력하는 프로그램을 Pr12_1_1_TemperatureConversion_TextBased_FtoK 클래스로 작성하라.  
