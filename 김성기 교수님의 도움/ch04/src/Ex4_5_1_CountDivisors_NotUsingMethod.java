/**
 * [ CountDivisors_NotUsingFor ]: 
 *        100의 약수 개수와 1237의 소수 여부 출력(메소드 미사용)   
 *            
 *   o 프로그래밍 스타일 
 *     1) main() 메소드로만 클래스 구성
 *     2) 100의 약수 개수와 1237의 소수 여부 출력을 메소드 사용 않고서 작성
...
class Ex4_5_1_CountDivisors_NotUsingMethod {
	public static void main(String[] args)  {

		int cntDivisorsOf100 = 0;         // 100의 약수 개수를 0으로 초기화

		for (int i = 1; i <= 100; i++)    // for 문: i가 1부터 100까지 반복
		...
		for (int i = 1; i <= 1237; i++)   // for 문: i가 1부터 1237까지 반복
 ...
 * [ 프로그램의 이해 및 실행 ]
 *   
 *   1) 이 프로그램은  for 문을 이용하여 100의 약수 개수와 1237의 소수 여부를 출력한다.
 *  
 *   2) 프로그램을 실행하여 결과를 확인하라.
 *   
 *   3) 1000의 약수 개수와 12347의 소수 여부를 출력하도록 프로그램을 변경해보라.
 *     
