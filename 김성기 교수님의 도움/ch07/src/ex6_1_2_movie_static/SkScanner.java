...
public class SkScanner { 
	...
	//   Á¤¼ö, ½Ç¼ö, ¹®ÀÚ¿­, ½Äº°ÀÚ µîÀ» ÀÐ±â À§ÇØ ÀÔ·ÂµÈ ¸¶Áö¸· '\r', '\n'À» Á¦°Å½ÃÄÑ 
	//   ´ÙÀ½¿¡ getChar()¸¦ ÇßÀ» ¶§ '\r', '\n'ÀÌ ÀÐÇôÁöÁö ¾Ê°Ô ÇÔ
	...
	//    Á¤¼öºÎ°¡ ¾øÀ¸¸é¼­ '.' ´ÙÀ½¿¡ ¼Ò¼öºÎ µðÁöÆ®°¡ ÀÔ·ÂµÇÁö ¾ÊÀ¸¸é ´Ù½Ã ½Ç¼ö ÀÔ·ÂÀÌ ½ÃÀÛµÇ¾î¾ß ÇÑ´Ù. 
...
//			System.out.println("  o tail of identifier = '" + (char) c + "' (" + c + ")"); 
	 ...
	 * 
	 * ÀÔ·ÂÇÒ ¶§ ÇÁ·ÒÇÁÆ® ¸Þ½ÃÁö ¾øÀÌ ÀÔ·ÂÀ» ÇÏ¸é »ç¿ëÀÚ´Â ¸·¿¬È÷ ±â´Ù¸®´Â °æ¿ì°¡ ¹ß»ýÇÑ´Ù.
	 * ÀÌ·¯ÇÑ °æ¿ì¸¦ ¹æÁöÇÏ±â À§ÇØ ÀÔ·Â ½Ã¿¡´Â ¸Þ½ÃÁö¸¦ ¹Ì¸® Ãâ·ÂÇÏ¿© 
	 * ÀÔ·ÂÇÒ µ¥ÀÌÅÍÀÇ ¿ëµµ³ª ±â´ÉÀ» ¾Ë·ÁÁÖ´Â ¸Þ½ÃÁö¸¦ ÇÁ·ÒÇÁÆ® ¸Þ½ÃÁö¶ó ÇÑ´Ù.
	 * 
	 * Æ¯È÷ Å°º¸µå¿¡¼­ÀÇ ÀÔ·Â ½Ã ÇÁ·ÒÇÁÆ® ¸Þ½ÃÁö´Â Áß¿äÇÏ´Ù.  
	 */
