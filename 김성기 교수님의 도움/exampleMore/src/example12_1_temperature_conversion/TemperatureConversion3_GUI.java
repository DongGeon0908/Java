...
/**
 * [ TemperatureConversion3_GUI ]: GUI로 작성된, 화씨온도를 섭씨온도로 변환하여 출력하는 프로그램
 *                                (입력 처리를 하지 않음)
 *        
 *     o 온도 체계
...
class TemperatureConversion3_GUI  {
 ...
 *      Pr12_1_2_TemperatureConversion3_GUI_CtoF 클래스로 작성하라. 
 *      (이 프로그램도 역시 화씨온도를 입력하여도 섭씨온도는 출력되지 않게 한다.)
 *   
 *   2) 이 프로그램은 화씨온도를 섭씨온도로 변환하여 출력하기 위해 작성되었다. 
 *      화씨온도를 캘빈 온도로  변환하여 출력하기 위한 프로그램을 
 *      TemperatureConversion3_GUI_CtoK 클래스로 작성하라.  
 *      (이 프로그램도 역시 화씨온도를 입력하여도 캘빈 온도는 출력되지 않게 한다.) 
 */
