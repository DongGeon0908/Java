...
/**
 * [ TemperatureConversion2_UsingMethodWithReturnValue ]: 
...
class TemperatureConversion2_UsingMethodWithReturnValue  {
 ...
 *  [ 실습과제 ] 
 *  
 *   o 섭씨온도를 캘빈온도로 변환하고 캘빈온도를 섭씨온도로 변환하는 작업을 메뉴 3번과 4번으로 추가하고 
