...
/*
 * [ PatientMgmt_UsingSubclass ]: 의사가 병원 개원하여 환자를 친료하는 상황을 나타내는 프로그램
 * 
 *   o 프로그래밍 스타일
 *     1) 여러 클래스들로 구성하여 병원(clinic)의 실제 엄무를 수행하는 프로그램을 작성
 *     2) Doctor와 Patient 클래스를 Person의 하위 클래스로 작성함
 *     3) 각 클래스에 필요한 메소드를 작성
 *
 */

class Ex7_PatientMgmt_UsingSubclass { 
