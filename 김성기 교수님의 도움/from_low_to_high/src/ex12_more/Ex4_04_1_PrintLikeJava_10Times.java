 ...
 *   
 *    o 스타일 1: 반복문 사용하지 않고 덩일한 문장을 여러번 나열하기
 *      
 *    o 반복 작업
 *      - 똑같은 작업을 반복하는 프로그램을 반복문을 사용하지 않고서 직접 작성해보는 것은 
 *        반복문의 중요성을 이해하기 위해 매우 중요함
 *        
 *      - 반복문을 사용하지 않고서 직접 반복문장을 나열하는 것은 반복 회수에 따라 난이도가 
 *        달라짐 
 *        
 *      - 반복회수가 작을 때는 때에는 대수롭지 않다가, 회수가 많아지면 점점 어려워져 회수가 
 *        아주 많아지면 거의 불가능해 보이기도 함 
    
 */
class Ex4_04_1_PrintLikeJava_10Times  {
...
/* 
 * [ 실습과제 ]
 *   1) "I like Java "를 21번 출력하는 프로그램을 Pr4_4_1_PrintLikeJava_21Times 
 *       클래스로 작성하라.
 *          
 *   2) "I like Java "를 121번 출력하는 프로그램을 Pr4_4_1_PrintLikeJava_121Times 
 *        클래스로 작성하라.
 *         
 *   3) "I like Java "를 1221번 출력하는 프로그램을 Pr4_4_1_PrintLikeJava_1221Times 
 *      클래스로 작성하라.
 *          
 *   4) "I like Java "를 12321번 출력하는 프로그램을 Pr4_4_1_PrintLikeJava_12321Times 
 *      클래스로 작성하라.  
 *   
 *  
 * [ 참고사항 ]
 ...
 *      확실한 방법을 고안해야 한다. (가능한 방법을 찾아보고, 안되면 하지않아도 됨)
 *     
 *     다음 장에서 12345654321번이라도 정확히 출력할 수 있는 몇 가지 방법을 알려줄 것이다.
 *         
