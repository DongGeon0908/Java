...
/*
 *  [ UnitConversion_Amazing ]: 여러 종류의 도량형 단위(Unit of weights and measures) 간의 변환을 하는 프로그램
 *  
...
class Ex4_09_2_UnitConversion_Amazing {

	public static void main(String[] args)  {
		String unitNamesFrom[] =  // 변환전 도량형 단위명을 저장하는 배열변수
			{ "", "m", "yard", "Km", "mile", "kg", "pound", "g", "don", "m*m", "평" };

		String unitNamesTo[] =   // 변환후 도량형 단위명을 저장하는 배열변수
			{ "", "yard", "m",  "mile", "Km", "pound", "kg", "don", "g", "평", "m*m" };
