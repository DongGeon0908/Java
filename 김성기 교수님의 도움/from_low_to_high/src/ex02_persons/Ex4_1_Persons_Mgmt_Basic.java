...
/*
 * [ Ex4_1_Persons_Mgmt_Basic ]: 신상정보 추가, 전체 보기, 위치 이동, 나이 변경, 신상정보 삭제 등의 신상정보 관리업무 수행(배열, if, For 문장을 이용)
 *
 *   o 프로그래밍 스타일
 *     1) main() 메소드로만 클래스 구성
...
class Ex4_1_Persons_Mgmt_Basic {
	public static void main(String[] args) {
		...
		while(true) { // 종료 메뉴를 선택할 때까지 반복함 
			...
			while (true) { // 올바른 업무에 대한 메뉴가 선택될 때까지 반복하여 업무 메뉴를 선택함 
				...
				System.out.println("    1) 신상정보 추가");
				System.out.println("    2) 신상정보 전체 보기");
				System.out.println("    3) 위치 이동");
				System.out.println("    4) 나이 1 증가");
				System.out.println("    5) 신상정보 삭제");
