...
/*
 * [ Persons_InOut_UsingArrayFor ]: 신상정보 입력한 후 저장 및 출력(배열과 For 문장을 이용)
 * 
 *   o 프로그래밍 스타일 
 *     1) main() 메소드로만 클래스 구성
 *     2) 배열변수 선언, For 문장을 이용한 간결한 입력, 저장, 원소 출력
 *               
...
class Ex2_5_4_Persons_InOut_UsingArrayFor {
 ...
 *   
 *      Ex2_5_4_Persons_InOut_UsingArrayFor 클래스가 선언되어 있으며, 클래스 내부에 
 *      main() 메소드가 작성되어 있다. 
 *      
 ...
 *      SkScanner.getXxxWithPrompt()을 사용하여 입력에 필요한 문장을 하나로 줄인다. 
 *       
 ...
 * [ 실습과제 ]
 *
 *   o 모두 5명의 신상정보를 저장하고 출력할 수 있도록 프로그램을 수정하라.
 *                 
 */
