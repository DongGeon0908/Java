...
class Ex4_3_PrintDiamond_WidthAny {
	public static void main(String args[]) {
		...
		// 다이아몬드 문자 증가 부분: 라인마다 blank 1개 감소, 문자 2개 증가  
		...
		// 다이아몬드 문자 감소 부분: 라인마다 blank 1개 증가, 문자 2개 감소
 ...
 *  [ 실습과제 ]
 *  
 *    1) 이 프로그램은 '*'를 이용하여 폭이 9인 다이아몬드를 그려준다. 이 프로그램 스타일로 
 *       '$'를 이용하여 폭이 15인 다이아몬드를 그리는 프로그램을 Pr4_3_PrintDiamond_Width로 
 *       작성하라. 
 *       
 *    2) 이 프로그램 스타일로 폭이 121인 다이아몬드 또는 폭이 1221인 다이아몬드를 
 *       프로그램을 작성할 수 있겠는가? 이 역시 할 수는 있지만 엄청 수고스러운 작업인가? 
 * 
 * 
 *  [ 스스로 생각하고 고민해볼 과제 ]
 *    
 *    1) 이 프로그램은 Ex4_2_PrintDiamond_Width9 클래스에서 반복되는 문장들을 통합한
 *       프로그램으로 폭이 9인 다이아몬드만 그리는 것이 아니라 어떠한 폭인 다이아몬드도
 *       그릴 수 있는 유용성이 높은 프로그램이다.
 *       
